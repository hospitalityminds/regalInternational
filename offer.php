...
<html lang="en">
    ...
    <head>
        ...
        <title>Special Offers an Discounts - Traders Hotel</title>
        <meta charset="utf-8">
...
<!--navbar-->
        ...
        <div class="slide-one-item home-slider owl-carousel">
            <div class="site-blocks-cover overlay" style="background-image: url(images/regal/19.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
                <div class="container">
        ...
        <div class="title-box  text-center">
            <h3 class="title-heading"> Offers </h3>
        ...
        <div class="row" style="padding: 2em 0;">
            ...
            <div class="col-md-6">
                <h3 class="abt-text" style="font-size: 2rem;">Get rooms at just INR 1299/-  per night if you are staying for 10 days and above.</h3><br>
            </div>
        </div>
    </div>
